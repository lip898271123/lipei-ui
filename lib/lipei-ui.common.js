...
/* harmony default export */ var affixvue_type_script_lang_js_ = ({
    ...
    methods: {
        handleScroll: function handleScroll() {
            ...
            // Fixed Top
            if (Math.abs(elOffset.top - this.offsetTop) < scrollTop && this.offsetType == 'top' && !affix) {
                this.affix = true;
                this.slotStyle = {
            ...
            } else if (Math.abs(elOffset.top - this.offsetTop) > scrollTop && this.offsetType == 'top' && affix) {
                this.slot = false;
                this.slotStyle = {};
                this.affix = false;
                this.styles = null;

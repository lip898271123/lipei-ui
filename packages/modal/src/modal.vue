                ...
                <div :class="classes" :style="mainStyles" v-show="visible" @mousedown="handleMousedown">
                    <div :class="contentClasses" ref="content" :style="contentStyles" @click="handleClickModal">
                        <a :class="[prefixCls + '-close']" v-if="closable" @click="close">
                            <slot name="close">
                                <i class="lp-icon-close iconfont icon-close1"></i>
                            </slot>
                        </a>
...
<script>
    ...
    import { findComponentsDownward } from 'main/utils/assist';
    import { transferIndex as modalIndex, transferIncrease as modalIncrease } from 'main/utils/transfer-queue';
    const prefixCls = 'lp-modal';
    export default {
        name: 'lpModal',
        ...
        methods: {
            ...
            EscClose (e) {
                if (this.visible && this.closable) {
                    if (e.keyCode === 27) {
                        const $Modals = findComponentsDownward(this.$root, 'lpModal').filter(item => item.$data.visible && item.$props.closable);
                        //console.log($Modals)
